    ...
    public void onClick(View view) {
        ...
        switch(view.getId()){
            ...
            case R.id.sign_in_button:
                ...
                if(isConnected) {
                    startActivityForResult(new Intent(WelcomeScreen.this, GoogleActivity.class), signInRequestCode);
                }
                else{
                    Toast.makeText(WelcomeScreen.this,getResources().getString(R.string.no_internet_connection),Toast.LENGTH_LONG).show();
                }
                break;
            case R.id.signUp:
                intent=new Intent(WelcomeScreen.this,SignUpActivity.class);
                startActivity(intent);
                break;
            case R.id.login:
                intent= new Intent(WelcomeScreen.this, LoginActivity.class);
                startActivity(intent);
                break;
